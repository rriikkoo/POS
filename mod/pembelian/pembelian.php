<?php
	...
	//link buat paging
	$linkaksi = 'med.php?mod=pembelian';
	...
	$aksi = 'mod/pembelian/act_pembelian.php';
		...
		default :
			...
			echo"<table style='margin-top:12px;'>
				<tr>
					...
					<td align='right'><a href='med.php?mod=pembelian' class='w3-btn w3-dark-grey w3-small'><i class='fa fa-refresh'></i> Refresh</a>
					<a href='med.php?mod=pembelian&act=form' class='w3-btn w3-small w3-blue'><i class='fa fa-file'></i> Tambah</a></td>
				</tr>
				...
				if($fd_kul > 0)
				{
					...
					while ($m = mysql_fetch_assoc($sql_kul)) {
						echo"<tr>
							...
							<td><a href='$aksi?mod=pembelian&act=hapus&id=$m[no_faktur]' onclick=\"return confirm('Yakin hapus data');\"><i class='fa fa-trash w3-large w3-text-red'></i></a>
							</td>
		...
		case "detail" :
			...
			if(isset($_GET['id']))
			{
				...
				<p>
					...
					<a href='med.php?mod=pembelian&act=form' class='w3-btn w3-red w3-tiny'><i class='fa fa-cart-plus'></i> Transaksi Baru</a>
				</p>";
