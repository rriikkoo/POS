		...
		default :
			...
			echo"<table style=\"margin-top:12px;\">
				<tr>
					...
					<td align='right'><a href='med.php?mod=user' class='w3-btn w3-small'><i class='fa fa-refresh'></i></a>
					<a href='med.php?mod=user&act=form' class='w3-btn w3-small w3-blue'><i class='fa fa-user-plus'></i></a></td>
				</tr>
				...
				if($fd_kel > 0)
				{
					...
					while ($m = mysql_fetch_assoc($sql_kel)) {
						echo"<tr>
							...
							<td>$m[last_login]</td>
							<td><a href='med.php?mod=user&act=form&id=$m[id_user]'><i class='fa fa-pencil-square w3-large w3-text-blue'></i></a></td>
						</tr>";
